                                ...
                                <div class="flex items-center gap-x-2">
                                    <div>
                                        @if($transaction->status == 'unpaid')
                                            <button data-modal-target="deleteModal{{ $transaction->id }}" data-modal-toggle="deleteModal{{ $transaction->id }}" type="button" class="inline-flex justify-center items-center px-5 py-2.5 text-sm font-medium text-center border border-red-700 text-red-700 rounded-lg focus:ring-4 focus:ring-red-200 dark:focus:ring-red-900 hover:bg-gray-50">
                                                Cancel
                                            </button>
                                            <div id="deleteModal{{ $transaction->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 items-center w-full md:inset-0 h-modal md:h-full">
                                                <div class="flex items-center relative p-4 w-full sm:max-w-2xl h-full md:h-auto">
